 ...
 * 修改内容:  <修改内容>
 */
package com.gxb.lazynetlibrary.net.http;

import android.content.Context;

import com.gxb.lazynetlibrary.cache.CacheLoaderConfiguration;
import com.gxb.lazynetlibrary.cache.disk.naming.HashCodeFileNameGenerator;
import com.gxb.lazynetlibrary.cache.memory.MemoryCache;
import com.gxb.lazynetlibrary.cache.util.MemoryCacheUtils;
import com.gxb.lazynetlibrary.net.http.cache.CacheHttpResponeHandlerBase;
import com.gxb.lazynetlibrary.net.http.cache.CacheHttpThread;
import com.gxb.lazynetlibrary.net.http.cache.CacheResponseListener;
import com.gxb.lazynetlibrary.net.http.cache.CacheTextResponseListener;
import com.gxb.lazynetlibrary.net.http.cache.HttpCacheLoadType;
import com.gxb.lazynetlibrary.net.http.cache.HttpCacheLoaderManager;
import com.gxb.lazynetlibrary.net.http.cache.SizeOfHttpCacheCalculator;
import com.gxb.lazynetlibrary.net.http.cache.callback.AsyncCacheJsonResponseCallback;
import com.gxb.lazynetlibrary.net.http.cache.callback.AsyncCacheTextResponseCallback;
import com.gxb.lazynetlibrary.net.http.core.AsyncHttpClient;
import com.gxb.lazynetlibrary.net.http.core.HttpRequestMethod;
import com.gxb.lazynetlibrary.net.http.core.HttpResponseHandlerBase;
import com.gxb.lazynetlibrary.net.http.core.HttpThread;
import com.gxb.lazynetlibrary.net.http.core.RequestParam;
import com.gxb.lazynetlibrary.net.http.core.callback.ResponseCallbackInterface;
